sprite_change_offset("idle", 24, 24);
sprite_change_offset("hurt", 31, 39);
sprite_change_offset("crouch", 24, 24);
sprite_change_offset("walk", 24, 24);
sprite_change_offset("walkturn", 24, 24);
sprite_change_offset("dash", 24, 24);
sprite_change_offset("dashstart", 24, 24);
...
sprite_change_offset("dashorb", 32, 32)
sprite_change_offset("yelloworb_animation", 32, 32)
sprite_change_offset("blueportal_animation", 32, 32)
sprite_change_offset("blackorb_animation", 32, 32)
sprite_change_offset("dashorb_animation", 32, 32)
sprite_change_offset("orangeportal_animation", 32, 32)
sprite_change_offset("blueportal1", 72, 32)
sprite_change_offset("blueportal2", 72, 32)
...
sprite_change_offset("ftilt", 32, 32);
...
sprite_change_offset("crouch", 32, 32);
sprite_change_offset("walk", 32, 32);
sprite_change_offset("walkturn", 32, 32);
sprite_change_offset("dash", 32, 32);
sprite_change_offset("dashstart", 32, 32);
sprite_change_offset("dashstop", 32, 32);
sprite_change_offset("dashturn", 32, 32);

sprite_change_offset("jumpstart", 32, 32);
sprite_change_offset("jump", 32, 32);
sprite_change_offset("doublejump", 32, 32);
sprite_change_offset("walljump", 32, 32);
sprite_change_offset("pratfall", 32, 32);
sprite_change_offset("land", 32, 32);
sprite_change_offset("landinglag", 32, 32);
